...
export default function AiAirportsView({ triggerToast }: AiAirportsViewProps) {
  ...
  const getStatusBadge = (state: string) => {
    switch (state) {
      ...
      case 'Beta':
        return <span className="bg-[#0E457F]/15 text-[#47B6E6] text-[11px] font-bold px-2 py-0.5 rounded">Beta</span>;
      case 'Negociando':
      default:
        return <span className="bg-[#47B6E6]/15 text-[#47B6E6] text-[11px] font-bold px-2 py-0.5 rounded">Beta / Piloto</span>;
    }
  };
  ...
  return (
    <div className="animate-fade-in space-y-7">
      ...
      <div className="flex items-center justify-between border-b border-[#c3dae4] pb-5">
        <div>
          <h2 className="text-[20px] font-semibold text-[#0F1A2C] tracking-tight">AI Airports</h2>
          <p className="text-[13px] text-[#64748B] mt-0.5">Despliegues activos y métricas de IA en aeropuertos</p>
        </div>
            ...
            <form onSubmit={handleAddAirport} className="p-5 space-y-4">
              <div className="grid grid-cols-3 gap-3">
                <div className="col-span-1">
                  <label className="block text-[12px] font-medium text-[#64748B] uppercase tracking-wider mb-1.5">Código IATA</label>
                  <input 
                    type="text" 
                    value={iata}
                ...
                <div className="col-span-2">
                  <label className="block text-[12px] font-medium text-[#64748B] uppercase tracking-wider mb-1.5">Nombre Aeropuerto</label>
                  <input 
                    type="text" 
                    value={name}
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-[12px] font-medium text-[#64748B] uppercase tracking-wider mb-1.5">Ciudad · País</label>
                  <input 
                    type="text" 
                    value={country}
                ...
                <div>
                  <label className="block text-[12px] font-medium text-[#64748B] uppercase tracking-wider mb-1.5">Pasajeros/día (estimado)</label>
                  <input 
                    type="text" 
                    value={passengers}
              ...
              <div>
                <label className="block text-[12px] font-medium text-[#64748B] uppercase tracking-wider mb-1.5">Módulos de IA iniciales</label>
                <select 
                  value={activeModules}
