...
export default function InvestorsView({ 
  ...
  const getStatusBadge = (state: string) => {
    switch (state) {
      ...
      case 'En proceso':
      default:
        return <span className="bg-[#8DA2B5]/15 text-[#64748B] text-[11px] font-semibold px-2 py-0.5 rounded text-xs">En proceso</span>;
    }
  };
    ...
    <div className="animate-fade-in space-y-7">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
        <div className="bg-white border border-[#e6eef4] rounded-lg p-5 relative overflow-hidden before:content-[''] before:absolute before:top-0 before:left-0 before:right-0 before:height-[2px] before:bg-[#0E457F]">
          ...
          <div className="text-[28px] font-bold text-[#0F1A2C] mt-2 tracking-tight leading-none">${(totalRaised / 1000000).toFixed(1)}M</div>
        ...
        <div className="bg-white border border-[#e6eef4] rounded-lg p-5 relative overflow-hidden before:content-[''] before:absolute before:top-0 before:left-0 before:right-0 before:height-[2px] before:bg-[#47B6E6]">
          ...
          <div className="text-[28px] font-bold text-[#0F1A2C] mt-2 tracking-tight leading-none">24.5%</div>
        ...
        <div className="bg-white border border-[#e6eef4] rounded-lg p-5 relative overflow-hidden before:content-[''] before:absolute before:top-0 before:left-0 before:right-0 before:height-[2px] before:bg-[#00C9A7]">
          ...
          <div className="text-[28px] font-bold text-[#0F1A2C] mt-2 tracking-tight leading-none">$9.8M</div>
          <div className="text-[12px] text-[#10CC82] flex items-center gap-1 mt-2.5">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 items-start">
        ...
        <div className="bg-white border border-[#e6eef4] rounded-lg lg:col-span-7">
          <div className="border-b border-[#e6eef4] px-5 py-4 flex items-center justify-between">
            <h3 className="text-[14px] font-semibold text-[#0F1A2C]">Inversores</h3>
            ...
            <table className="w-full">
              <thead>
                <tr className="bg-white/[0.02]">
                  <th className="px-5 py-3 text-left text-[11px] font-semibold text-[#64748B] uppercase tracking-wider border-b border-[#e6eef4]">Inversor</th>
                  <th className="px-5 py-3 text-left text-[11px] font-semibold text-[#64748B] uppercase tracking-wider border-b border-[#e6eef4]">Ronda</th>
                  <th className="px-5 py-3 text-left text-[11px] font-semibold text-[#64748B] uppercase tracking-wider border-b border-[#e6eef4]">Monto</th>
                  <th className="px-5 py-3 text-left text-[11px] font-semibold text-[#64748B] uppercase tracking-wider border-b border-[#e6eef4]">% equity</th>
                  ...
                  <th className="px-5 py-3 text-center border-b border-[#e6eef4]"></th>
                </tr>
              </thead>
                ...
                {investors.map((inv) => (
                  <tr key={inv.id} className="hover:bg-[#0E457F]/4 transition-colors">
                    <td className="px-5 py-3">
                      <div className="font-semibold text-[#0F1A2C] text-[13.5px]">{inv.name}</div>
                    ...
                    <td className="px-5 py-3 text-[#64748B] text-[13.5px] font-mono">
                      {inv.sharesPercent}%
                    </td>
                    <td className="px-5 py-3">
        ...
        <div className="bg-white border border-[#e6eef4] rounded-lg lg:col-span-5 p-5 space-y-6">
          <h3 className="text-[14px] font-semibold text-[#0F1A2C]">Cap Table de Distribución</h3>
          
          <div className="space-y-4">
            {/* Custom visual progress bars for each major shareholder */}
            <div className="space-y-1.5">
              <div className="flex justify-between items-center text-[13px]">
                <span className="text-[#0F1A2C]">Founders &amp; CEO (S. Mazorra)</span>
                <span className="font-semibold text-[#64748B]">52.4%</span>
              </div>
            ...
            <div className="space-y-1.5">
              <div className="flex justify-between items-center text-[13px]">
                <span className="text-[#0F1A2C]">Andes Ventures LLC</span>
                <span className="font-semibold text-[#64748B]">5.0%</span>
              </div>
              <div className="w-full bg-[#2A415A] h-1.5 rounded-full overflow-hidden">
            ...
            <div className="space-y-1.5">
              <div className="flex justify-between items-center text-[13px]">
                <span className="text-[#0F1A2C]">Santiago de Alvear</span>
                <span className="font-semibold text-[#64748B]">3.5%</span>
              </div>
              <div className="w-full bg-[#2A415A] h-1.5 rounded-full overflow-hidden">
            ...
            <div className="space-y-1.5">
              <div className="flex justify-between items-center text-[13px]">
                <span className="text-[#0F1A2C]">Clara Ortiz (SaaS Global)</span>
                <span className="font-semibold text-[#64748B]">3.6%</span>
              </div>
              <div className="w-full bg-[#2A415A] h-1.5 rounded-full overflow-hidden">
            ...
            <div className="space-y-1.5">
              <div className="flex justify-between items-center text-[13px]">
                <span className="text-[#0F1A2C]">AeroCapital SL</span>
                <span className="font-semibold text-[#64748B]">2.4%</span>
              </div>
              <div className="w-full bg-[#2A415A] h-1.5 rounded-full overflow-hidden">
            ...
            <div className="space-y-1.5">
              <div className="flex justify-between items-center text-[13px]">
                <span className="text-[#0F1A2C]">Option pool</span>
                <span className="font-semibold text-[#64748B]">33.1%</span>
              </div>
              <div className="w-full bg-[#2A415A] h-1.5 rounded-full overflow-hidden">
          ...
          <div className="border-t border-[#e6eef4] pt-5">
            <h4 className="text-[14px] font-semibold text-[#0F1A2C] mb-3">Próxima ronda objetivo</h4>
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-50 bg-[#0F1A2C]/80 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-white border border-[#e6eef4] rounded-xl w-full max-w-md shadow-2xl overflow-hidden animate-zoom-in">
            <div className="border-b border-[#e6eef4] px-5 py-4 flex items-center justify-between">
              <h3 className="text-base font-semibold text-[#0F1A2C]">Añadir Nuevo Inversor</h3>
              <button 
