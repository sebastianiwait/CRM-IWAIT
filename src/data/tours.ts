...
export const TOURS: Record<string, TourStep[]> = {
  inicio: [
    ...
    { target: 'global-search', title: 'Búsqueda global', body: 'Busca inversores, negocios o tareas desde cualquier lugar. Es el atajo más rápido.' },
  ...
  negocios: [
    { title: 'Tu CRM comercial', body: 'Cada negocio es una oportunidad con su empresa, contactos y actividad. Te muestro cómo se usa.' },
    { target: 'deal-tabs', title: 'Pipeline o Tabla', body: 'El Pipeline te da la vista por etapas; la Tabla, la lista completa con filtros.' },
    { target: 'deal-board', title: 'Arrastra entre etapas', body: 'Mueve un negocio de Prospecto hasta Cerrado ganado. Cada cambio queda registrado solo en su historial.' },
    { target: 'deal-add', title: 'Crear un negocio', body: 'Registra la empresa, el valor, la fecha de cierre y su primer contacto. Luego ábrelo para añadir actividad.' }
  ]
};
